...
.\models\yue2\gcp\run_cloud_generation.ps1 `
    ...
    -LyricsFile "examples\yue2\lyrics\lyrics_weight_of_the_world.txt" `
    -AbcFile "examples\yue2\scores\weight_of_the_world_part1.abc" `
    -Temperature 0.85 `
    -CfgScale 1.25 `
    -Seed 777 `
...
.\models\yue2\gcp\run_cloud_generation.ps1 -SuiteScript "models\yue2\gcp\run_weight_of_the_world_suite.sh"
```
